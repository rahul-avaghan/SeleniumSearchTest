...
You can execute the project with Maven build.
Steps:
1. Open a terminal window/command prompt
2. 
3. `cd selenium_search_test` (Or whatever folder you cloned it into)
4. `mvn clean verify`

All dependencies should now be downloaded and the tests listed in TestCase sheet should run successfully in headless mode (Assuming you have Firefox installed in the default location)
