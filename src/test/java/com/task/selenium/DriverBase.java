...
import com.task.selenium.config.DriverFactory;
import com.task.selenium.listeners.ScreenshotListener;
...
/**
 * The DriverBase Class provides methods that are required to interact
 * with WebDriver
