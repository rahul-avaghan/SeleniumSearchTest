...
import static com.task.selenium.config.DriverType.FIREFOX;
import static com.task.selenium.config.DriverType.valueOf;
...
public class DriverFactory {
    ...
    public RemoteWebDriver getDriverbyName() throws Exception {
        if (null == driver) {
            instantiateWebDriver(selectedDriverType);
        }
